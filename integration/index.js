...
var ASM_CONSTS = {
  94888: () => { if (document.fullscreenElement) return 1; },  
 94934: () => { return Module.canvas.width; },  
 94966: () => { return parseInt(Module.canvas.style.width); },  
 95014: () => { document.exitFullscreen(); },  
 95041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 95114: () => { if (document.fullscreenElement) return 1; },  
 95160: () => { return Module.canvas.width; },  
 95192: () => { return screen.width; },  
 95217: () => { document.exitFullscreen(); },  
 95244: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 95377: () => { return window.innerWidth; },  
 95403: () => { return window.innerHeight; },  
 95430: () => { if (document.fullscreenElement) return 1; },  
 95476: () => { return Module.canvas.width; },  
 95508: () => { return parseInt(Module.canvas.style.width); },  
 95556: () => { if (document.fullscreenElement) return 1; },  
 95602: () => { return Module.canvas.width; },  
 95634: () => { return screen.width; },  
 95659: () => { return window.innerWidth; },  
 95685: () => { return window.innerHeight; },  
 95712: () => { if (document.fullscreenElement) return 1; },  
 95758: () => { return Module.canvas.width; },  
 95790: () => { return screen.width; },  
 95815: () => { document.exitFullscreen(); },  
 95842: () => { if (document.fullscreenElement) return 1; },  
 95888: () => { return Module.canvas.width; },  
 95920: () => { return parseInt(Module.canvas.style.width); },  
 95968: () => { document.exitFullscreen(); },  
 95995: ($0) => { Module.canvas.style.opacity = $0; },  
 96033: () => { return screen.width; },  
 96058: () => { return screen.height; },  
 96084: () => { return window.screenX; },  
 96111: () => { return window.screenY; },  
 96138: () => { return window.devicePixelRatio; },  
 96174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 96227: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96278: () => { Module.canvas.style.cursor = 'none'; },  
 96315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96571: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96622: () => { if (document.fullscreenElement) return 1; },  
 96668: () => { return window.innerWidth; },  
 96694: () => { return window.innerHeight; },  
 96721: () => { if (document.pointerLockElement) return 1; }
};
